package nl.iusearchbtw.tutorialmod.item;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.minecraft.item.*;
import net.minecraft.item.tooltip.TooltipType;
import net.minecraft.text.Text;
import nl.iusearchbtw.tutorialmod.TutorialMod;
import net.minecraft.registry.Registries;
import net.minecraft.registry.Registry;
import net.minecraft.util.Identifier;
import nl.iusearchbtw.tutorialmod.item.custom.ChiselItem;
import nl.iusearchbtw.tutorialmod.item.custom.HammerItem;
import nl.iusearchbtw.tutorialmod.item.custom.ModArmorItem;
...
public class ModItems {
  ...
  public static final Item NECRON_CHESTPLATE = registerItem("necron_chestplate",
    new ArmorItem(ModArmorMaterials.NECRON_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings()
      .maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))));
  public static final Item NECRON_LEGGINGS = registerItem("necron_leggings",
    new ArmorItem(ModArmorMaterials.NECRON_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings()
      .maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))));
  public static final Item NECRON_BOOTS = registerItem("necron_boots",
    new ArmorItem(ModArmorMaterials.NECRON_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings()
      .maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))));
