...
public class ModArmorMaterials {
  ...
  public static final RegistryEntry<ArmorMaterial> NECRON_ARMOR_MATERIAL = registerArmorMaterial("necron",
    () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
      map.put(ArmorItem.Type.BOOTS, 2);
      map.put(ArmorItem.Type.LEGGINGS, 4);
      map.put(ArmorItem.Type.CHESTPLATE, 6);
      map.put(ArmorItem.Type.BODY, 4);
    }), 20, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, () -> Ingredient.ofItems(ModItems.CAULIFLOWER),
      List.of(new ArmorMaterial.Layer(Identifier.of(TutorialMod.MOD_ID, "necron"))), 0, 0));
